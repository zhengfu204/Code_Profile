...
function generateBackgroundElements(background_height) {
    ...
    return `<rect width="100%" height="${background_height}px" fill="#2C3E50" rx="5" y="30"/>`;
}

function generateBarTitle(title, totalLength, typingSpeed) {
    return `<rect width="100%" height="30" fill="black" rx="5" y="0" />
...
app.post('/submit-text', (req, res) => {
    ...
    generateSvgCode(text, typingSpeed, title);
